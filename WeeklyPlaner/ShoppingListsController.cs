...
namespace WeeklyPlaner
{
    public class ShoppingListsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Timestamp")] ShoppingList shoppingList)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Timestamp")] ShoppingList shoppingList)
        {
            if (ModelState.IsValid)
            {
